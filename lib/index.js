      ...
      var firePromise = new Promise(function (resolve, reject) {
        ...
        listeners.forEachAsync(function (listener, next) {
          ...
          _lodash2["default"].forEach(results, function (result, listenerIndexName) {
            _this3._runtime.stack[event._stackIndex].listeners[listenerIndexName].result = results[listenerIndexName];
          });
          ...
          Promise.all(Object.values(results).map(function (result) {
            return result.data;
