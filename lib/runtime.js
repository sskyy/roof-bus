...
function walkObject(data, handler) {
  ...
  if (_lodash2["default"].isFunction(data) || !_lodash2["default"].isObject(data)) return;

  _lodash2["default"].forEach(data, function (subData, key) {
...
var Runtime = (function () {
  ...
  _createClass(Runtime, [{
    ...
    value: function initializeData() {
      return _lodash2["default"].cloneDeep(this._definition, function (child) {
    ...
    value: function setup() {
      _lodash2["default"].extend(this, this.initializeData());
    }
  }, {
    key: "reset",
    value: function reset() {
      ...
      walkObject(this._definition, function (data, key, path) {
        if (data instanceof Facade) {
          if (_lodash2["default"].isFunction(_lodash2["default"].get(_this, path).destroy)) {
            _lodash2["default"].get(_this, path).destroy();
          }
          //stop walking
          return false;
        }
