...
var Runtime = (function () {
  ...
  Runtime.prototype.initializeData = function initializeData() {
    return _utilJs2["default"].cloneDeep(this._definition, function (child) {
      if (child instanceof Facade) {
        return new (_bind.apply(child.ctor, [null].concat(child.args)))();
      }
    });
  };

  Runtime.prototype.setup = function setup() {
