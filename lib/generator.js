...
var Bus = (function () {
    ...
    Bus.prototype.callListener = function callListener(listener, snapshot, args) {
        //执行单个监听器,一定返回一个promise
        if (isGenerator(listener.fn)) {
            return _co2["default"](regeneratorRuntime.mark(function callee$2$0() {
                var _listener$fn;
                ...
                return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
                    while (1) switch (context$3$0.prev = context$3$0.next) {
                        case 0:
                            context$3$0.next = 2;
                            return (_listener$fn = listener.fn).call.apply(_listener$fn, [snapshot].concat(args));
            ...
            return Promise.resolve((_listener$fn2 = listener.fn).call.apply(_listener$fn2, [snapshot].concat(args)));
        }
    };
    ...
    Bus.prototype.fireListeners = function fireListeners(event, listeners, data) {
        ...
        var firePromise = _co2["default"](regeneratorRuntime.mark(function callee$2$0() {
            var _loop, _ret;
    ...
    Bus.prototype.snapshot = function snapshot(event, listener) {
        ...
        _lodash2["default"].extend(snapshot, _lodash2["default"].clone(this));
    ...
    Bus.prototype.makeEventStack = function makeEventStack(event, listenersOrderedList) {
        ...
        var clonedListenerArray = _lodash2["default"].cloneDeep(listenersOrderedList.toArray(), function (item) {
            if (item instanceof Set) {
                ...
                return _lodash2["default"].zipObject([].concat(item.keys()), [].concat(item.values()));
