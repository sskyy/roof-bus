...
var Bus = (function () {
    ...
    _createClass(Bus, [{
        ...
        value: function fireListeners(event, listeners, data) {
                    ...
                    while (1) switch (context$3$0.prev = context$3$0.next) {
                        ...
                        case 2:
                            _loop = regeneratorRuntime.mark(function callee$3$0() {
                                var snapshot, result, promiseToWait, disableNames;
                                return regeneratorRuntime.wrap(function callee$3$0$(context$4$0) {
                                    ...
                                    while (1) switch (context$4$0.prev = context$4$0.next) {
                                        ...
                                        case 5:
                                            ...
                                            promiseToWait = [].concat(_toConsumableArray(listener.waitFor)).reduce(function (list, waitForName) {
                                            ...
                                            result = this.parseResult(Promise.all(promiseToWait).then(function () {
                                                return _this2.callListener(listener, snapshot, data);
                                            }));
                                            context$4$0.next = 22;
                                            break;
            ...
            firePromise["catch"](function (err) {
                //一旦出现问题，循环会自动终止。
