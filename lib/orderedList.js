...
var OrderedList = (function () {
  ...
  _createClass(OrderedList, [{
    ...
    value: function insert(key, value) {
      ...
      if (_lodash2["default"].isUndefined(key) || _lodash2["default"].isUndefined(value)) throw new Error("key and value cannot be undefined");
    ...
    value: function applyOrderAround(obj, orderName) {
      var orderKeys = [].concat(_toConsumableArray(obj.order[orderName]));
    ...
    value: function lineUp(obj) {
      ...
      var waitForKeys = [];
      if (obj.order.before) waitForKeys = waitForKeys.concat([].concat(_toConsumableArray(obj.order.before)));
      if (obj.order.after) waitForKeys = waitForKeys.concat([].concat(_toConsumableArray(obj.order.after)));
      ...
      Array.prototype.forEach.call([].concat(_toConsumableArray(obj._waiting)), function (waitForKey) {
